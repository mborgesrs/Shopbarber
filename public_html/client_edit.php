...
<form method="post" class="bg-white p-4 rounded shadow max-w-lg">
  ...
  <label class="block mb-2">Telefone <input name="phone" id="phone" value="<?=htmlspecialchars($client['phone'] ?? '')?>" class="w-full border p-2 rounded" maxlength="15" onkeyup="handlePhone(event)"></label>
