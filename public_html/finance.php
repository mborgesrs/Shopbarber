        ...
        <tr class="hover:bg-gray-50/80 transition-colors group">
          ...
          <td class="px-6 py-2 text-right">
            <div class="flex justify-end gap-1.5 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
              ...
              <a title="Excluir" class="w-7 h-7 flex items-center justify-center rounded-lg bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white transition-all shadow-sm" href="finance_delete.php?id=<?=$r['id']?>" onclick="confirmAction(event, this.href, 'Excluir?')">
